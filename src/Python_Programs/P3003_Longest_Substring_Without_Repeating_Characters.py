...
# It uses a sliding window approach to achieve O(n) time complexity and O(m) space
# complexity, where m is the size of the character set.
# The program prompts the user for a string, counts the length of the longest substring,
